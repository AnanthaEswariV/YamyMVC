                    ...
                    using (var conn = new MySqlConnection(builder.ConnectionString))
                    {
                       ...
                       CREATE TABLE IF NOT EXISTS `tbl_coa_level_1` (
                        ...
                        INSERT INTO `tbl_coa_level_4` (`id`, `name`, `code`, `main_id`, `debit`, `credit`, `date`, 'costCenter') VALUES
	                        (1, 'Bank Account', 1101001, 1, 0.000, 0.000, NULL, NULL),
	                        (2, 'Petty Cash', 1102001, 2, 0.000, 0.000, NULL, NULL),
	                        (3, 'Accounts Receivable', 1103001, 3, 0.000, 0.000, NULL, NULL),
	                        (4, 'Raw Material Inventory', 1104001, 4, 0.000, 0.000, NULL, NULL),
	                        (5, 'Finish Goods Inventory', 1104002, 4, 0.000, 0.000, NULL, NULL),
	                        (6, 'Prepayment Government', 1105001, 5, 0.000, 0.000, NULL, NULL),
	                        (7, 'Prepayment Rent', 1105002, 5, 0.000, 0.000, NULL, NULL),
	                        (8, 'Prepayment Other\'s', 1105003, 5, 0.000, 0.000, NULL, NULL),
	                        (9, 'Deposits', 1106001, 6, 0.000, 0.000, NULL, NULL),
	                        (10, 'Taxes Paid (Input)', 1106002, 6, 0.000, 0.000, NULL, NULL),
	                        (11, 'Advance payments to employees', 1106003, 6, 0.000, 0.000, NULL, NULL),
	                        (12, 'Fixed Assets Net', 1201001, 8, 0.000, 0.000, NULL, NULL),
	                        (13, 'Suppliers (Creditors)  Net', 2101001, 9, 0.000, 0.000, NULL, NULL),
	                        (14, 'Accrued Salaries', 2102001, 10, 0.000, 0.000, NULL, NULL),
	                        (15, 'Accrued Sales commission', 2102002, 10, 0.000, 0.000, NULL, NULL),
	                        (16, 'Accrued Leave Salary', 2102003, 10, 0.000, 0.000, NULL, NULL),
	                        (17, 'Sales Tax Payable', 2103001, 11, 0.000, 0.000, NULL, NULL),
	                        (18, 'PDC CHQ', 2103002, 11, 0.000, 0.000, NULL, NULL),
	                        (19, 'Advance from Customers', 2103004, 11, 0.000, 0.000, NULL, NULL),
	                        (20, 'Gratuity Provision', 2201001, 12, 0.000, 0.000, NULL, NULL),
	                        (21, 'Capital - Opening Balance', 3101001, 13, 0.000, 0.000, NULL, NULL),
	                        (22, 'Opening Balance Equity', 3201001, 15, 0.000, 0.000, NULL, NULL),
	                        (23, 'Sales - Local', 4101001, 18, 0.000, 0.000, NULL, NULL),
	                        (24, 'Sales - GCC', 4101002, 18, 0.000, 0.000, NULL, NULL),
	                        (25, 'Materials Purchased', 5101001, 21, 0.000, 0.000, NULL, NULL),
	                        (26, 'Employee Salary Advance', 1108001, 57, 0.000, 0.000, NULL, NULL),
	                        (27, 'Employee Loans', 1108002, 57, 0.000, 0.000, NULL, NULL),
	                        (28, 'Other Employee Receivables', 1101002, 1, 0.000, 0.000, NULL, NULL),
	                        (29, 'Accrued Salary', 2102004, 10, 0.000, 0.000, NULL, NULL),
	                        (30, 'Employee Payables', 2105001, 59, 0.000, 0.000, NULL, NULL),
	                        (31, 'Stock Settlement Gain', 46501001, 68, 0.000, 0.000, NULL, NULL),
	                        (32, 'Accumlated Dep Fur', 1201002, 8, 0.000, 0.000, NULL, NULL),
	                        (33, 'PDC Receivable', 1103002, 3, 0.000, 0.000, NULL, NULL),
	                        (34, 'PDC Receivable Return', 1103003, 3, 0.000, 0.000, NULL, NULL),
	                        (35, 'PDC Receivable Hold', 1103004, 3, 0.000, 0.000, NULL, NULL),
	                        (36, 'PDC Receivable Cancel', 1103005, 3, 0.000, 0.000, NULL, NULL),
	                        (37, 'PDC Payable', 1111001, 69, 0.000, 0.000, NULL, NULL),
	                        (38, 'PDC Payable Return', 1111002, 69, 0.000, 0.000, NULL, NULL),
	                        (39, 'PDC Payable Hold', 1111003, 69, 0.000, 0.000, NULL, NULL),
	                        (40, 'PDC Payable Cancel', 1111003, 69, 0.000, 0.000, NULL, NULL),
	                        (41, 'Sales Discount', 6101004, 25, 0.000, 0.000, NULL, NULL),
	                        (42, 'Cash On Hand', 1103006, 3, 0.000, 0.000, NULL, NULL),
	                        (43, 'Sales Return', 4101003, 19, 0.000, 0.000, NULL, NULL);
