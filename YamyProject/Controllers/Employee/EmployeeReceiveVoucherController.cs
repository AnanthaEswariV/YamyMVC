namespace YamyProject.Controllers.Employee
    {
    public class EmployeeReceiveVoucherController(IPaymentVoucherService PaymentVoucher, IListServices listServices, YamyDbContext context): Controller
        {
